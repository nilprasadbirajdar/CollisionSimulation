...
{
    /*collision->setDebrisSpeed(speed);
    collision->setDebrisRadius(size);
    collision->setDebrisDistance(altitude);*/
...
void OpenGLWindow::updateSolarSystemData()
{
    //mVertices.clear();
    //mColors.clear();
    collision->drawSolarSystem(mVerticess, mColorss);
    update();
}
...
void OpenGLWindow::updateData(QVector<GLfloat>& vertices,QVector<GLfloat>& colors)
{
